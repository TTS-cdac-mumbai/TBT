...
int DEBUG=1, parseLevel=0, pruiningFlag=0, syllTagFlag=0, fliteHTSFlag=0, doubleParseSyl=0;//parselevel - 0-mono 1-syll  //syldictFlag=0,
...
void SetlangId(int id, char * word){
   if(id>=3328 && id<=3455){currLang = MALAYALAM;} //malayalam
      ...
      printf("this is hinnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnndiiiiiiiiiiiiiiiiiiiii\n");
      char * ret=system("sh /home/cdac/tts_work/Unified-parser-23rdAugujst2018/Atish-Edited-Working-Parser/lang.sh");
...
int SetlanguageFeat(char* input){
   ...
   SetlangId((int)firstLet,input);      ///////aaaaaaatttttttttiiiiiissssssshhhhhhhhh
...
char* SchwaDoubleConsonent(char * phone){
   ...
   char * vowelList[42]={"av&","nwv&","nnv&","rwv&","lwv&","lnv&","aav&","iiv&","uuv&","rqv&","eev&","eiv&","ouv&",
                                                    ...
                                                    "a&","e&","i&","o&","u&"};
   for(i=0;i<38;i++){ // chnaged by atish
      for(j=0;j<39;j++){
         for(k=0;k<42;k++){
            strcpy(c1,"&euv&");
...
char* SchwaSpecificCorrection(char * p){   // by atish
   ...
   char * vowelList[42]={"av&","nwv&","nnv&","rwv&","lwv&","lnv&","aav&","iiv&","uuv&","rqv&","eev&","eiv&","ouv&",
                                                    ...
                                                    "ee&","ei&","ou&","oo&","ax&","ai&","ev&","uv&",
                                                    "a&","e&","i&","o&","u&"};
   //printf("the passed phone to schwaspec is=%s\n",phone);
   char *phone = (char *) malloc (1000 * sizeof(char)); // by atish
  strcpy(phone,p);   // by atish
   ...
   //     }
   //  }
  printf("before for loop upto 38 and schwaList=%c\n",schwaList[1]);
   for(i=0;i<38;i++){ //### 38 to 34 by atish
      printf("inside 38 iteration  for= %d \n",i);
      strcpy(c1,"&av&");
      printf("first C1=%s\n",c1);
      strcat(c1,schwaList[i]);
      printf("2nd C1=%s\n",c1);      
      ...
      for(j=0;j<41;j++){
         strcpy(c4,"&euv&");
         printf("innner for loop 1st C4=%s\n",c1);
         strcat(c4,c3);
         strcat(c4,"$");
      	strcat(c4,vowelList[j]);
      	strcpy(c2,c1);
      	strcat(c2,vowelList[j]);
        printf("innner for loop 2nd C2=%s\n",c2);
        printf("sixth C1=%s\n",c1);
         //if(DEBUG)printf("%s\t%s\n",c2,c4);
      	if(strstr(phone, c2) != NULL)phone =Utf8ReplaceAll(c2,"@",phone);
      	if(strstr(phone, "@") != NULL)phone =Utf8ReplaceAll("@",c4,phone);
      }
      printf("this is after inner for loop\n");
   }
   //if(strstr(phone, "#") != NULL)phone =Utf8ReplaceAll("#","",phone);
    printf("this is after outer for loop\n");
   if(strstr(phone, "$") != NULL)phone =Utf8ReplaceAll("$","",phone);

    printf("this is before second loop of for loop\n");
   //&q&w&eu&
   for(i=0;i<39;i++){
      printf("in second loop of for\n");
      strcpy(c1,"&q&");
      strcat(c1,schwaList[i]);
      strcat(c1,"&euv&");
      strcpy(c2,"&q&");
      ...
      if(strstr(phone, c1) != NULL)phone =Utf8ReplaceAll(c1,"@",phone);
      if(strstr(phone, "@") != NULL)phone =Utf8ReplaceAll("@",c2,phone);
      printf("End of second loop of for\n");
   }
  // printf("after 2nd looooooooooooooooooooooooooppppppppppp\n");	
   // for(i=0;i<39;i++){
   //    strcpy(c1,"&eu&");
   //    strcat(c1,schwaList[i]);
   //    strcat(c1,"&eu&");
   ...
   //
   // }
  // printf("printing end of phone=%s\n",phone);
   return phone;
}
...
#line 1582 "unified.tab.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 1578 "unified.y" /* yacc.c:355  */

	char* strval;

#line 1640 "unified.tab.c" /* yacc.c:355  */
};
...
#line 1655 "unified.tab.c" /* yacc.c:358  */
...
{
       0,  1587,  1587,  1599,  1610,  1613,  1614,  1615,  1616,  1617,
...
#line 2740 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 1599 "unified.y" /* yacc.c:1646  */
    {  		/*	int length = strlen($1);
   			int j = 0;
   			if ( $1[length -1] == 'h'){
   				char str[length];
...
#line 2756 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 1610 "unified.y" /* yacc.c:1646  */
...
#line 2762 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 1613 "unified.y" /* yacc.c:1646  */
    { (yyval.strval) = (yyvsp[0].strval); }
#line 2768 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 1614 "unified.y" /* yacc.c:1646  */
    { if(DEBUG)printf("kaki : %s\n",(yyvsp[0].strval) );(yyval.strval) = (yyvsp[0].strval); }
#line 2774 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 1615 "unified.y" /* yacc.c:1646  */
    { (yyval.strval) = (yyvsp[0].strval); }
#line 2780 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 1616 "unified.y" /* yacc.c:1646  */
    { (yyval.strval) = (yyvsp[0].strval); }
#line 2786 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 1617 "unified.y" /* yacc.c:1646  */
    { (yyval.strval) = (yyvsp[0].strval); }
#line 2792 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 1618 "unified.y" /* yacc.c:1646  */
    { (yyval.strval) = (yyvsp[0].strval); }
#line 2798 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 1619 "unified.y" /* yacc.c:1646  */
    {  (yyval.strval)=(yyvsp[0].strval);/*char* str = malloc(strlen($1)+strlen("्")+4); sprintf( str,"%s&#",$1 );printf("\nconsonant:\t");$$=str*/; }
#line 2804 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 1620 "unified.y" /* yacc.c:1646  */
    { (yyval.strval) = (yyvsp[0].strval); }
#line 2810 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 1621 "unified.y" /* yacc.c:1646  */
    { (yyval.strval) = (yyvsp[0].strval); }
#line 2816 "unified.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 1622 "unified.y" /* yacc.c:1646  */
    { (yyval.strval) = (yyvsp[0].strval); }
#line 2822 "unified.tab.c" /* yacc.c:1646  */
    break;


#line 2826 "unified.tab.c" /* yacc.c:1646  */
      default: break;
    }
