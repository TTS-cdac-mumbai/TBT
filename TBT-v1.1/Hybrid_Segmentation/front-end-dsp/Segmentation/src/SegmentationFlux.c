/*-------------------------------------------------------------------------
 *  SegmentationFlux.c - A program for finding phone transitions with significant spectral change
 *
 *  Purpose: Smooth SBSF and find locations of significant spectral change   
 *
 *  Authors: Aswin Shanmugam S  (sas91@outlook.com)  and  Hema A. Murthy  (hema@cse.iitm.ac.in)
 *
